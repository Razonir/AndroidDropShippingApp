...
public class ebayAliexpressSellPriceIls extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ebay_aliexpress_sell_price_ils, container, false);
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!amazonPriceInput.getText().toString().equals("") && !profitWontedInput.getText().toString().equals("")){
                    ...
                    float sellPriceAfterCalc = (float) ((float) ((profitWontedVal+curDollarRate*(amazonPriceVal+shippingCostVal))/PAYPALTEX)/PAYPALDOLLAR);
                    ...
                    while(Math.floor(realprofit)!=Math.floor(temp)){
                        profitWontedVal++;
                        sellPriceAfterCalc = (float) ((float) ((profitWontedVal+curDollarRate*amazonPriceVal)/PAYPALTEX)/PAYPALDOLLAR);
