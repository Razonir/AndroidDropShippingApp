...
public class ebayAmazonProfitIls extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ebay_amazon_profit_ils, container, false);
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!amazonPriceInput.getText().toString().equals("") && !sellPriceInput.getText().toString().equals("")){
                    ...
                    float profitResultAfterCalc = (float) (((sellPriceVal+shippingChargeVal)*PAYPALTEX*PAYPALDOLLAR)-((sellPriceVal+shippingChargeVal)*sellerRate*curDollarRate)-((amazonPriceVal+shippingCostVal)*AMAZONTEX*AMAZONDOLLAR));
