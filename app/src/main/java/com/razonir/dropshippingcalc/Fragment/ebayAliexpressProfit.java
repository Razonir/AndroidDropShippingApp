...
public class ebayAliexpressProfit extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ebay_aliexpress_profit, container, false);
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!amazonPriceInput.getText().toString().equals("") && !sellPriceInput.getText().toString().equals("")){
                    ...
                    float profitResultAfterCalc = (float) (((sellPriceVal+shippingChargeVal)*PAYPALTEX)-((sellPriceVal+shippingChargeVal)*sellerRate)-((amazonPriceVal+shippingCostVal)));
