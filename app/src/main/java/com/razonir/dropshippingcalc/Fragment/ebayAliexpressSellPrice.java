...
public class ebayAliexpressSellPrice extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ebay_aliexpress_sell_price, container, false);
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(!amazonPriceInput.getText().toString().equals("") && !profitWontedInput.getText().toString().equals("")){
                    ...
                    float sellPriceAfterCalc = (float) ((profitWontedVal+(amazonPriceVal+shippingCostVal))/PAYPALTEX);
                    ...
                    while(Math.floor(realprofit)!=Math.floor(temp)){
                        profitWontedVal++;
                        sellPriceAfterCalc = (float) ((profitWontedVal+amazonPriceVal)/PAYPALTEX);
